// Name: EVAN WILCOX      Date: 10/02/17
  ...
  do 
  {
    ...
    switch(choice)
    {
      ...
      case 3: 
        ...
        {
          cout << "Must complete 1 and 2 first." << endl;
        }        
        break;
      ...
      case 4:
        ...
        {
          cout << "Must complete 3 first." << endl;
        }
        break;
    }
  } while(choice != 5);
...
void printMinutes(int num)
{
  cout << endl << "You should nap for " << num << " minutes." << endl;
  return;
}
...
void printCalories(const int calories)
{
  cout << "You require " << calories << " calories daily." << endl;
  return;
}
